...
export default function AcademicDetailPage() {
  ...
  return (
    <>
      ...
      {/* 학기 성적 요약 */}
      <AcademicSummaryCard earnedCredits={data.semesterGrades.earnedCredits} gpa={data.semesterGrades.semesterGpa} classRank={data.semesterGrades.classRank} totalStudents={data.semesterGrades.totalStudents} />
