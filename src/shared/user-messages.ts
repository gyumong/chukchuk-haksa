...
const BY_APP_CODE: Record<string, string> = {
  ...
  A03: '신입생은 아직 학기 기록이 없습니다.\n다음 학기부터 확인하실 수 있어요.',
  U03: '이미 포털과 연동된 계정입니다.\n다른 계정으로 로그인했는지 확인해주세요.',
  U04: '아직 학교 포털과 연동되지 않았습니다.\n포털 연동을 먼저 진행해주세요.',
  A07: '지금은 강의평가 대상 학기가 아닙니다.\n평가 기간에 다시 확인해주세요.',
  A08: '제출하신 과목이 강의평가 대상과 일치하지 않습니다.\n다시 확인 후 시도해주세요.',
};
